...
public enum MachinePart222 implements MachinePart {
    ...
    private static final Map<String, MachinePart222> NAME_LOOKUP = new HashMap<String, MachinePart222>();
    ...
    public static MachinePart222 byName(String name) {
        return NAME_LOOKUP.get(name);
    }

    static {
        for (MachinePart222 part : values()) {
            NAME_LOOKUP.put(part.getName(), part);
        }
    }
}