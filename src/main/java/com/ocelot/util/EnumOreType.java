...
{
    IRON("iron", 1, () -> ModItems.IRON_ORE, () -> ModBlocks.IRON_ORE_OUTCROP.getDefaultState()), COPPER("copper", 1, () -> ModItems.COPPER_ORE, () -> Blocks.GOLD_ORE.getDefaultState()), COAL("coal", 1, () -> Items.COAL, () -> Blocks.COAL_BLOCK.getDefaultState()), STONE("stone", 1, () -> Blocks.STONE, () -> Blocks.STONE.getDefaultState()), URANIUM("uranium", 2, () -> Items.SLIME_BALL, () -> Blocks.SLIME_BLOCK.getDefaultState());
